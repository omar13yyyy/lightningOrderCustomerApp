...
@Composable
fun RegisterCheckPhoneNumberScreen(
    authViewModel: AuthViewModel = viewModel(),
    navController: NavHostController,
) {
    var phoneNumber by remember { mutableStateOf("") }
    val confirmationState by authViewModel.confirmationState.collectAsState()
    val confirmationResponse by authViewModel.confirmationResponse.collectAsState()
    ...
    MyAppTheme {
        Column(
            ...
            when (confirmationState) {
                is ConfirmationState.Idle , is ConfirmationState.Error-> {
                    FilledButton(
                        text = "Send",
                        ...
                        if (phoneNumber != null) {
                            authViewModel.confirmation(phoneNumber=phoneNumber)
                ...
                is ConfirmationState.Success -> {
                    ...
                    navController.navigate(ROUTES.REGISTER_PHONE_NUMBER_VERIFICATION_SCREEN.name)
                }
